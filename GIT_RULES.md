...
本项目目前为**单人开发**，采用简化的 Git 工作流，直接在 `master` 分支上提交。
...
- ✅ **直接在 master 分支开发** - 无需创建 feature 分支
- ✅ **每完成一个功能点就提交** - 保持提交频率
...
| 类型 | 说明 | 示例 |
|------|------|------|
| `feat` | 新功能 | `feat: 实现工具注册系统` |
| `fix` | Bug 修复 | `fix: 修复 MySQL 连接错误` |
| `docs` | 文档更新 | `docs: 更新 PLAN.md` |
| `style` | 代码格式（不影响逻辑） | `style: 格式化 Python 代码` |
| `refactor` | 重构 | `refactor: 优化 Agent Loop 结构` |
| `test` | 测试 | `test: 添加工具注册测试` |
