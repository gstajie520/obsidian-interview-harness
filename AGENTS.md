...
**System Prompt**: `.harness/prompts/interviewer.md`
...
**System Prompt**: `.harness/prompts/scheduler.md`
...
**System Prompt**: `.harness/prompts/linker.md`
...
**System Prompt**: `.harness/prompts/analyzer.md`
...
**System Prompt**: `.harness/prompts/supervisor.md`
...
**System Prompt**: `.harness/prompts/buddy.md`
...
report = await supervisor.generate_weekly_report()
```
...
review_list = await scheduler.get_daily_review_list()
```
